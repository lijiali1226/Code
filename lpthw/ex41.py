...
def princess_live_here():
    ...
    if eat_it == "eat it":
        ...
        print "The Princess screams as you cram the cake in her month."
...
def gold_koi_pond():
    ...
    print "It opens its month waiting for food."
    ...
    if feed_it == "feed it":
        ...
        print "The Koi grimaces, then thrashed around for a second."
        ...
        print "You can't see it's happy, it then grunts, thrashes..."
...
def bear_with_sword():
    ...
    print "a bear bearing a laod bearing sword walks in."
...
ROOMS = {
    'death':death,
    'princess_live_here': princess_live_here,
...
runner(ROOMS, 'princess_live_here')
